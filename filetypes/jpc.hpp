...
typedef struct color_prm color_env;
...
public:
	...
	JPCError save_changes(int num_textures); //Instead of updating chunk data with variables here, rely on user to save them to help eliminate dynamic types (chunk save will update the data field)
};
